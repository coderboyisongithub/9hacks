...
Original file is located at
    https://colab.research.google.com/drive/1r6iyZzln_joMU_SvwrmAbX58PR-cCymE
"""
...
incecption_v3=tf.keras.applications.inception_v3.InceptionV3(
    weights='imagenet',
    include_top=False
)
...
def get_feature_vector(img_path):
  ...
  feature_vector=incecption_v3(img)
  return img,feature_vector

img,feature_vector=get_feature_vector('/content/donwload.jpg')
plt.imshow(np.squeeze(img,axis=0))
plt.axis('off')
plt.show()

print("feature size:",feature_vector.shape)

"""download dataset"""

captions=pd.read_csv(f'/content/drive/MyDrive/8k/captions.txt')
captions.head()
captions['image']=captions['image'].apply(lambda x:f'/content/drive/MyDrive/8k/Images/{x}')
...
caption_model.save_weights('my_model_weights.h5')
...
l1.append(pred_caption.split('.')[0].strip())
print(l1)
...
prompt = "Summarize the sentence given as  News Letter \n\n"
